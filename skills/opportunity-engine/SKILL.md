...
2. **OPP-002**: Check if the site lacks comparison content or review data on product pages.
...
6. Generate proactive Opportunity records for each detected architectural optimization.
